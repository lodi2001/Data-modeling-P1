...
songplay_table_insert = ("""
    ...
    JOIN staging_songs  s   ON (se.song = s.title AND se.artist = s.artist_name AND se.length = s.duration)
...
select_count_rows_queries= [count_rows_staging_events, count_rows_staging_songs, count_rows_songplays, count_rows_users, count_rows_songs, count_rows_artists, count_rows_time]
